import type { AssistantMessage, ImageContent, TextContent, ThinkingContent } from "@oh-my-pi/pi-ai";
...
import type { AssistantThinkingRenderer, AssistantThinkingRenderResult } from "./extension-types";

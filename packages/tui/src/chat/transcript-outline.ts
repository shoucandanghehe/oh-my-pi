...
import type { VirtualViewportFrame, VirtualViewportProvider, VirtualViewportRequest } from "../tui";
import type { TranscriptContainer } from "../chrome/transcript-container";
